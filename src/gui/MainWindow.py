...
"")
        ...
        self.button_Client.setMinimumSize(QtCore.QSize(200, 40))
        self.button_Client.setMaximumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.button_Server.setMinimumSize(QtCore.QSize(200, 40))
        self.button_Server.setMaximumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("BankGothic Md BT")
        font.setPointSize(20)
...
"color: rgb(255, 255, 255);")
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(220, 40, 770, 651))
        font = QtGui.QFont()
...
"border-radius: 15px;}")
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(20, 20, 732, 211))
        ...
        self.hint_cFilename.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.hint_cFileize.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.Layout_schedule.setSpacing(8)
        self.Layout_schedule.setObjectName("Layout_schedule")
        self.label_spacer1 = QtWidgets.QLabel(self.verticalLayoutWidget_5)
        self.label_spacer1.setMinimumSize(QtCore.QSize(300, 0))
        self.label_spacer1.setText("")
        self.label_spacer1.setObjectName("label_spacer1")
        self.Layout_schedule.addWidget(self.label_spacer1)
        self.hint_schedule = QtWidgets.QLabel(self.verticalLayoutWidget_5)
        self.hint_schedule.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_spacer2 = QtWidgets.QLabel(self.verticalLayoutWidget_5)
        self.label_spacer2.setMinimumSize(QtCore.QSize(10, 0))
        self.label_spacer2.setText("")
        self.label_spacer2.setObjectName("label_spacer2")
        self.Layout_schedule.addWidget(self.label_spacer2)
        ...
        self.label_spacer1_2 = QtWidgets.QLabel(self.Client)
        self.label_spacer1_2.setGeometry(QtCore.QRect(540, 120, 300, 45))
        self.label_spacer1_2.setMinimumSize(QtCore.QSize(300, 0))
        self.label_spacer1_2.setText("")
        self.label_spacer1_2.setObjectName("label_spacer1_2")
        ...
        self.button_Startlistening.setGeometry(QtCore.QRect(550, 600, 101, 41))
...
"border-radius: 10px;")
        ...
        self.button_Stoplistening = QtWidgets.QPushButton(self.Server)
        self.button_Stoplistening.setGeometry(QtCore.QRect(660, 600, 101, 41))
        self.button_Stoplistening.setStyleSheet("background-color: rgb(192, 216, 251);\n"
"border-radius: 10px;")
        self.button_Stoplistening.setObjectName("button_Stoplistening")
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.Server)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 20, 732, 211))
        ...
        self.button_SelectfFile.setStyleSheet("background-image: url(./image/button_SelectFile.png);\n"
"border-radius: 10px;")
...
"border-radius: 10px;")
        ...
        self.groupBox_server = QtWidgets.QGroupBox(self.Setting)
        self.groupBox_server.setGeometry(QtCore.QRect(30, 300, 641, 140))
        font = QtGui.QFont()
        font.setFamily("標楷體")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.groupBox_server.setFlat(True)
        self.groupBox_server.setObjectName("groupBox_server")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.groupBox_server)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(30, 30, 591, 91))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.Layout_server1 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.Layout_server1.setContentsMargins(0, 0, 0, 0)
        self.Layout_server1.setObjectName("Layout_server1")
        self.Layout_server2 = QtWidgets.QHBoxLayout()
        self.Layout_server2.setObjectName("Layout_server2")
        self.hint_serverIP = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.hint_serverIP.setFont(font)
        self.hint_serverIP.setObjectName("hint_serverIP")
        self.Layout_server2.addWidget(self.hint_serverIP)
        self.input_serverIP = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.input_serverIP.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        self.input_serverIP.setFont(font)
        self.input_serverIP.setStyleSheet("background-color: rgba(170, 170, 255, 70);\n"
"border-radius: 10px;")
        self.input_serverIP.setAlignment(QtCore.Qt.AlignCenter)
        self.input_serverIP.setObjectName("input_serverIP")
        self.Layout_server2.addWidget(self.input_serverIP)
        spacerItem6 = QtWidgets.QSpacerItem(300, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.Layout_server2.addItem(spacerItem6)
        self.Layout_server1.addLayout(self.Layout_server2)
        self.Layout_server3 = QtWidgets.QHBoxLayout()
        self.Layout_server3.setObjectName("Layout_server3")
        self.hint_serverPort = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.hint_serverPort.setFont(font)
        self.hint_serverPort.setObjectName("hint_serverPort")
        self.Layout_server3.addWidget(self.hint_serverPort)
        self.input_serverPort = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.input_serverPort.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        self.input_serverPort.setFont(font)
        self.input_serverPort.setStyleSheet("background-color: rgba(170, 170, 255, 70);\n"
"border-radius: 10px;")
        self.input_serverPort.setInputMask("")
        self.input_serverPort.setMaxLength(5)
        self.input_serverPort.setFrame(True)
        self.input_serverPort.setAlignment(QtCore.Qt.AlignCenter)
        self.input_serverPort.setObjectName("input_serverPort")
        self.Layout_server3.addWidget(self.input_serverPort)
        spacerItem7 = QtWidgets.QSpacerItem(400, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.Layout_server3.addItem(spacerItem7)
        self.Layout_server1.addLayout(self.Layout_server3)
...
"border-radius: 10px;")
        ...
        spacerItem8 = QtWidgets.QSpacerItem(300, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.Layout_client1.addItem(spacerItem8)
...
"border-radius: 10px;")
        ...
        spacerItem9 = QtWidgets.QSpacerItem(400, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.Layout_client2.addItem(spacerItem9)
...
"border-radius: 10px;")
        ...
        self.button_OpenSaveFolder.setStyleSheet("background-image: url(./image/button_openSaveFile.png);\n"
"border-radius: 10px;")
        ...
        self.MainMin.setStyleSheet("border-image: url(./image/WindowMin.jpg);")
        ...
        self.MainClose.setStyleSheet("border-image: url(./image/WindowClose.jpg);\n"
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_Startlistening.setText(_translate("MainWindow", "開始聆聽"))
        self.button_Stoplistening.setText(_translate("MainWindow", "中斷聆聽"))
        ...
        self.groupBox_server.setTitle(_translate("MainWindow", "伺服器端設定"))
        self.hint_serverIP.setText(_translate("MainWindow", "IP地址(IPv4) :"))
        self.input_serverIP.setInputMask(_translate("MainWindow", "000.000.000.000"))
        self.hint_serverPort.setText(_translate("MainWindow", "Port(0~65535) :"))
        self.groupBox_client.setTitle(_translate("MainWindow", "用戶端設定"))
