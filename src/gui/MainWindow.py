...
"border-radius: 10px;")
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 10, 731, 311))
...
"border-radius: 10px;")
        ...
        self.horizontalLayout_4.addWidget(self.label_button_SelectfFile)
...
"border-radius: 10px;")
        ...
        self.horizontalLayout_4.addWidget(self.label_button_SelectfFolder)
        self.Layout_SelectFile.addLayout(self.horizontalLayout_4)
        self.GroupBox_SendboxKey = QtWidgets.QGroupBox(self.Server)
        self.GroupBox_SendboxKey.setGeometry(QtCore.QRect(20, 340, 731, 300))
...
"border-radius: 10px;")
        ...
        self.Layout_client3.addWidget(self.label_button_OpenSaveFolder)
