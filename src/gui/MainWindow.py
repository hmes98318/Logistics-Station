...
"border-radius: 10px;")
        ...
        self.UserPage_Background = QtWidgets.QFrame(self.User)
        self.UserPage_Background.setGeometry(QtCore.QRect(0, 0, 770, 650))
        self.UserPage_Background.setStyleSheet("border-radius: 15px;\n"
"background-image: url(./src/gui/image/UserPage_Background.png);")
        self.UserPage_Background.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.UserPage_Background.setFrameShadow(QtWidgets.QFrame.Raised)
        self.UserPage_Background.setObjectName("UserPage_Background")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.UserPage_Background)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(370, 350, 381, 139))
