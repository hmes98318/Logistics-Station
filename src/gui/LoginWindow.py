...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.frame.setStyleSheet("#frame{background-image:url(./image/LoginBackground.jpg);\n"
"border-radius: 20px;}")
        ...
        self.LoginMin.setStyleSheet("border-image: url(./image/WindowMin.jpg);")
        ...
        self.LoginClose.setStyleSheet("border-image: url(./image/WindowClose.jpg);")
...
"border-radius: 15px;")
        ...
        self.icon_ID.setStyleSheet("border-image: url(./image/Account_Icon.jpg);")
...
"border-radius: 15px;}")
        ...
        self.icon_PW.setStyleSheet("border-image: url(./image/Password_Icon.jpg);")
