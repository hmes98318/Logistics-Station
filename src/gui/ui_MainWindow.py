...
"background-color: rgba(13, 95, 160, 200);")
        ...
        self.hint_cFilename.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.hint_cFileize.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.label_cFilesize.setMinimumSize(QtCore.QSize(0, 50))
...
"}")
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 20, 732, 621))
...
"background-color: rgb(85, 170, 255);")
        ...
        self.Layout_SelectFile.addItem(spacerItem7)
        self.GroupBox_SendboxKey = QtWidgets.QGroupBox(self.verticalLayoutWidget_4)
...
"border-radius: 10px;")
        ...
        self.Layout_SelectFile.addWidget(self.GroupBox_SendboxKey)
...
" Package"))
        ...
        self.GroupBox_SendboxKey.setTitle(_translate("MainWindow", "<包裹資訊>"))
