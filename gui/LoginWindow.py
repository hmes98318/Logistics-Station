...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.frame.setStyleSheet("#frame{background-image:url(./gui/image/LoginBackground.jpg);\n"
"border-radius: 20px;}")
        ...
        self.LoginMin.setStyleSheet("border-image: url(./gui/image/WindowMin.jpg);")
        ...
        self.LoginClose.setStyleSheet("border-image: url(./gui/image/WindowClose.jpg);")
